        ...
        if self.attention_backend is None:
            ...
            if not use_mla_backend:
                ...
                if is_hopper_with_cuda_12_3():
                    ...
                    # FlashInfer's FA2 MLA decode kernel produces incorrect results
                    # on SM120. The FlashInfer MLA backend is patched with a manual
                    # PyTorch MLA decode fallback that is architecture-agnostic.
                    self.attention_backend = "flashinfer"
                elif is_hip():
